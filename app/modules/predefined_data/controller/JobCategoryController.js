...
const jobCategoryRepositories = require("../repositories/jobcategoryRepositories");
...
class JobCategoryController {
    ...
    async addJobCategory(req, res) {
        try {
            ...
            // const categoryExistsForIndustry = await jobCategoryRepositories.getJobCategoryByIndustryAndNormalizedName(industry, normalizedName);
            // if (categoryExistsForIndustry) {
            //     return res.status(400).json({
            //         status: false,
            //         errors: { name: 'Job category name is already present for this industry.' }
            //     });
            // }
