...
const educationSchema = new mongoose.Schema({
    level: {
        type: String,
        required: true,
        enum: ['Tenth', 'Twelfth', 'Diploma', 'Graduation', 'Post Graduation', 'PhD', 'Other']
    },
...
const userSchema = new mongoose.Schema({
    ...
    profile: {
        type: new mongoose.Schema({
            ...
            preferredIndustry: { type: mongoose.Schema.Types.ObjectId, ref: 'Industry' },
            preferredJobCategory: { type: mongoose.Schema.Types.ObjectId, ref: 'JobCategory' },
            preferredWorkMode: [{ type: String, enum: ['work from office', 'work from home', 'remote', 'hybrid'] }],
