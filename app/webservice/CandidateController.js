...
class CandidateController {
    async dashboard(req, res) {
        try {
            ...
            const dashboardData = {
                ...
                recommendedJobs: previewRecommendedJobs,
                totalRecommendedJobs
            }

            return res.status(200).json({
                status: true,
                message: 'candidate dashboard Data has been fetched successfully',
                data: dashboardData
            })
    ...
    async getCandidateprofileData(req, res) {
        try {
            ...
            return res.status(200).json({
                status: true,
                message: 'Candidate profile data has been fetched successfully',
                data: candidateData
            })
    ...
    async getRecruiterViewOfCandidateProfile(req, res) {
        try {
            ...
            return res.status(200).json({
                status: true,
                message: 'Candidate profile has been fetched successfully',
                data: candidateData
            })
