...
const { apiAuthenticateUser,apiAuthorizeRoles,apiCheckRecruiterAccess,apiOnlyAdminRecruiter } = require('../../middleware/auth');
...
namedRouter.get('api-recruiter-home','/recruiter/dashboard',apiAuthenticateUser,apiAuthorizeRoles('recruiter'),apiCheckRecruiterAccess,RecruiterController.dashboard);
namedRouter.get('api-recruiter-profile','/recruiter/profile',apiAuthenticateUser,apiAuthorizeRoles('recruiter'),apiCheckRecruiterAccess,RecruiterController.getRecruiterProfile);
namedRouter.put('api-update-recruiter-profile','/recruiter/update-profile',apiAuthenticateUser,apiAuthorizeRoles('recruiter'),apiCheckRecruiterAccess,userImageUpload.single('profilePicture'),RecruiterController.updateRecruiterProfile);
...
namedRouter.put('api-reject-recruiter','/recruiter/:id/reject',apiAuthenticateUser,apiAuthorizeRoles('recruiter'),apiCheckRecruiterAccess,apiOnlyAdminRecruiter,RecruiterController.rejectRecruiter);
...
namedRouter.get('api-recruiter-detail-info-job','/recruiter/jobs/:id/detail-information',apiAuthenticateUser,apiAuthorizeRoles('recruiter'),apiCheckRecruiterAccess,JobController.getDetailJobInformation);
...
namedRouter.get('api-recruiter-get-application-detail','/recruiter/applications/:id/details',apiAuthenticateUser,apiAuthorizeRoles('recruiter'),apiCheckRecruiterAccess,ApplicationController.getApplicationDetails);
namedRouter.get('api-recruiter-get-applications','/recruiter/applications/:jobId',apiAuthenticateUser,apiAuthorizeRoles('recruiter'),apiCheckRecruiterAccess,ApplicationController.getApplicationsPaginationByJobId);
namedRouter.put('api-recruiter-accept-appliation','/recruiter/applications/:id/accept',apiAuthenticateUser,apiAuthorizeRoles('recruiter'),apiCheckRecruiterAccess,ApplicationController.acceptApplication);
namedRouter.put('api-recruiter-reject-appliation','/recruiter/applications/:id/reject',apiAuthenticateUser,apiAuthorizeRoles('recruiter'),apiCheckRecruiterAccess,ApplicationController.rejectApplication);

// -- profile --
namedRouter.get('api-recruiter-get-candidate-profile','/recruiter/view-candidate/:id',apiAuthenticateUser,apiAuthorizeRoles('recruiter'),apiCheckRecruiterAccess,CandidateController.getRecruiterViewOfCandidateProfile);
