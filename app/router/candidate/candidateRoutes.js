...
const { authenticate,authorizeRoles,checkCompanyCreator } = require('../../middleware/auth');
...
namedRouter.post('profile-details-update','/candidate/profile/basic-details/update',authenticate,authorizeRoles('candidate'),CandidateController.updateCandidateBsicDetail);
namedRouter.post('profile-picture-update','/candidate/profile/profile-image/update',authenticate,authorizeRoles('candidate'),userImageUpload.single('profilePicture'),CandidateController.updateProfileImage);
...
namedRouter.post('canddate-profile-summary-update','/candidate/profile/profile-summary/update',authenticate,authorizeRoles('candidate'),CandidateController.updateCandidateProfileSummary);
...
namedRouter.post('candidate-skills-update','/candidate/profile/skills/update',authenticate,authorizeRoles('candidate'),CandidateController.updateCandidateSkills);
...
namedRouter.post('candidate-education-delete','/candidate/profile/education/:id/delete',authenticate,authorizeRoles('candidate'),CandidateController.deleteCandidateEducation);
...
namedRouter.post('candidate-workExperience-delete','/candidate/profile/workExperience/:id/delete',authenticate,authorizeRoles('candidate'),CandidateController.deleteCandidateWorkExperience);
...
namedRouter.post('candidate-career-preferences-update','/candidate/profile/career-preferences/update',authenticate,authorizeRoles('candidate'),CandidateController.updateCareerPreferences);

namedRouter.post('profile-resume-update','/candidate/profile/resume/update',authenticate,authorizeRoles('candidate'),pdfUpload.single('resume'),CandidateController.updateCandidateResume);
...
namedRouter.post('candidate-bookmark-job','/candidate/jobs/:id/bookmark',authenticate,authorizeRoles('candidate'),JobController.candidateBookMarkJob);
namedRouter.post('candidate-unbookmark-job','/candidate/jobs/:id/unbookmark',authenticate,authorizeRoles('candidate'),JobController.candidateUnbookMarkJob);
